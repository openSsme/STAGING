...
if (isset($_POST['form-submit'])){
	...
	if (!preg_match("/^[a-zA-Zא-ת]*$/", $nam)){
		...
		header("location:../signup.php?error=invalidname&lastname=".$las."&age=".$age."&phone=".$pho."&email=".$ema);
		exit();			
	...
	//lastname format validation
		...
		header("location:../signup.php?error=invalidlastname&name=".$nam."&age=".$age."&phone=".$pho."&email=".$ema);
		exit();			
	...
	//age format validation
		...
		header("location:../signup.php?error=invalidage&name=".$nam."&lastname=".$las."&phone=".$pho."&email=".$ema);
		exit();			
	...
	//age restriction
		...
		header("location:../signup.php?error=restriction&name=".$nam."&lastname=".$las."&phone=".$pho."&email=".$ema);
		exit();			
	...
	//phone number validation
		...
		header("location:../signup.php?error=invalidphone&name=".$nam."&lastname=".$las."&age=".$age."&email=".$ema);
		exit();			
	...
	//email format validation
		...
		header("location:../signup.php?error=invalidemail&name=".$nam."&lastname=".$las."&age=".$age."&phone=".$pho);
		exit();
	...
	//password format validation
		...
		header("location:../signup.php?error=invalidpass&name=".$nam."&lastname=".$las."&age=".$age."&phone=".$pho."&email=".$ema);
		exit();			
